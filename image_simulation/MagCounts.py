...
def Mag2Counts(lightcurves, airmass_per_obs, t_exp=225.0, zero_point=26.59, airmass_term=0.15):
...
def Count2Mag(counts, airmass_per_obs, t_exp=225.0, zero_point=26.59, airmass_term=0.15):
